...
server/memoryRetrieval.js  Assistente Inteligente de Projetos, Fase 1 (2026-09) — busca lexical (full-text search + unaccent) sobre `project_memory_chunks`, filtro por participante/reunião/data/tipo; getMeetingTranscriptChunks() (2026-09-10) busca a transcrição inteira de uma reunião sem ranking, pra explicar contexto de atividade — ver PROJECT_CONTEXT.md §27.

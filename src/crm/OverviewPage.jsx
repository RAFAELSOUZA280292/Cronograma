...
import { REL_META, fmtDateTimeBR, fmtDateBR, fmtMoney, daysLabel, staleColor, stageAgeColor } from './crmMeta.js';
import { CompletenessBar } from './ui.jsx';

export default function OverviewPage({ caps, refreshKey, onOpenCompany, onOpenDeal, onBootstrap, onGoDeals }) {
